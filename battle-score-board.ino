...
const int led = 13;
/*Nastaví  barvu konkrétní ledky v konkrétním řadiči - respektive změní v paměti, neposílá na hw */
void Np_Set(int driver,int led, int color){
  switch (driver){
    case STRIP_LL:
...
/*Commitne změny barev na řadiči - pošle to, co má v paměti*/
void Np_Show(int i){
...
/*
Na portu zobrazí číslo danou barvou. Nulu může ale nemusí vykreslovat
*/
...
/*pošle na všechny řadiče náhodné barvy*/
  void test_ada(){
    ...
    int buffer;
    /*zobrazuje náhodná čísla na řadičích*/
    void test_nr(){  
...
void milligramCss() {
  server.sendHeader("Expires", "Sat, 02 Apr 2039 12:00:00 GMT",false); 
  server.sendHeader("Cache-Control", "max-age=3600",false); 
